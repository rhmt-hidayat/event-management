...
<?= $this->section('content') ?>
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form action="<?= site_url('gawe/'.$gawe->id_gawe) ?>" method="post">
                <?= csrf_field() ?>
                <input type="hidden" name="_method" value="PUT">
                <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Gawe</label>
                <div class="col-sm-12 col-md-7">
                    <input type="text" class="form-control" name="name_gawe" value="<?= $gawe->name_gawe ?>" required>
                </div>
                </div>
                <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Deskripsi Gawe</label>
                <div class="col-sm-12 col-md-7">
                    <input type="text" class="form-control" name="info_gawe" value="<?= $gawe->info_gawe ?>" required>
                </div>
                </div>
                <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tanggal Gawe</label>
                <div class="col-sm-12 col-md-7">
                    <input type="date" class="form-control" name="date_gawe" value="<?= $gawe->date_gawe ?>" required>
                </div>
                </div>
                <div class="form-group row mb-4">
