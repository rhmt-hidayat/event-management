...
<body>
    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
            <div class="sidebar-brand">
                <a href="<?= site_url() ?>">e-Nikah</a>
            </div>
            <div class="sidebar-brand sidebar-brand-sm">
                <a href="<?= site_url() ?>">eN</a>
            </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2025 <div class="bullet"></div> Developed By <a href="https://rhmt-hidayat.github.io/web_portofolio/" target ="_blank">Phoenix</a>
        </div>
  ...
  <script src="<?= base_url() ?>/stisla/node_modules/bootstrap/dist/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
